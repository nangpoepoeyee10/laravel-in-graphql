...
return [
    ...
    //
        'types' => [
            ...
            'PostInput' => \App\GraphQL\Inputs\PostInput::class,
    ...
    'schemas' => [
        'default' => [
            ...
            'createUserWithPosts' => \App\GraphQL\Mutations\CreateUserWithPostsMutation::class,
            'updateUserWithPosts' => \App\GraphQL\Mutations\UpdateUserWithPostsMutation::class,
